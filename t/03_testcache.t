...
unless( $ENV{AWS_ACCESS_KEY_ID} && 
  ...
  plan skip_all => "We need Amazon Environment information to run tests. The following variables are needed. AWS_TEMPLATE_BUCKET,AWS_ACCESS_KEY_SECRET, AWS_ACCESS_KEY_ID ";

}
  plan skip_all => "TODO, Need to figure out how to test the caching.";
